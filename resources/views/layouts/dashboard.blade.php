            ...
            <div class="border-right sidebar-wrapper" deta-aos="fade-right">
                ...
                <div class="list-group list-group-flush mt-3">
                    ...
                    <a href="{{ route('dashboard-product') }}"
                        class="list-group-item {{ request()->is('dashboard-product*') ? 'active' : '' }}">My
                        Products</a>
                    <a href="{{ route('dashboard-transaction') }}"
                        class="list-group-item {{ request()->is('dashboard-transaction*') ? 'active' : '' }}">Transactions</a>
                    <a href="{{ route('dashboard-store-setting') }}"
                        class="list-group-item {{ request()->is('dashboard-store-setting*') ? 'active' : '' }}">Store
                        Setting</a>
                    <a href="{{ route('dashboard-account-setting') }}"
                        class="list-group-item {{ request()->is('dashboard-account-setting*') ? 'active' : '' }}">My
                        Account</a>
                </div>
            </div>
